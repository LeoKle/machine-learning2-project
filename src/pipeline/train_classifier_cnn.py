...
def train_classifier_cnn(train_loader, test_loader, dummy_input, lr=9.140946480582927e-05):
...
def tune_hyperparameters_cnn(dataset_type="CIFAR10"):
    def objective(trial):
        ...
        train_loader, test_loader, dummy_input = data_setup.prepare_dataset_for_cnn(dataset_type, batch_size)
